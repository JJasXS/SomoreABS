...
namespace YourApp.Data
{
    public class DbInitializer
    {
        ...
        public void EnsureAppointmentSchema()
        {
            ...
            // ✅ IMPORTANT:
            // Your AR_CUSTOMER.CODE and AGENT.CODE are:
            // - VARCHAR, UTF8, length_bytes=40
            // That typically corresponds to VARCHAR(10) CHARACTER SET UTF8.
            // So APPOINTMENT CUSTOMER_CODE / AGENT_CODE must match.
...
END",
                ...
                // 6) Foreign keys
                // These will succeed only if AR_CUSTOMER.CODE and AGENT.CODE are PK or UNIQUE.
